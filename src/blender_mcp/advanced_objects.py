...
class AdvancedObjectOperations:
    ...
    def _normalize_argument(value: Any) -> Any:
        if is_dataclass(value):
            return {key: AdvancedObjectOperations._normalize_argument(item)
                    for key, item in asdict(value).items()}
        if isinstance(value, dict):
            return {str(key): AdvancedObjectOperations._normalize_argument(item)
    ...
    def set_texture_to_material(self, material_name: str, texture_slot: str = 'Base Color', image_path: Optional[str] = None, color_ramp: Optional[tuple] = None) -> Dict[str, Any]:
    ...
    def create_image_texture_node(self, material_name: str, image_path: str, slot: str = 'Base Color', tile_x: int = 1, tile_y: int = 1, repeat: bool = False) -> Dict[str, Any]:
    ...
    def create_procedural_texture(self, material_name: str, texture_type: str = 'Checker', slot: str = 'Base Color', scale: float = 5.0, color1: tuple = (0.0, 0.0, 0.0, 1.0), color2: tuple = (1.0, 1.0, 1.0, 1.0)) -> Dict[str, Any]:
        """Create a procedural texture node and link it."""
        return self._dispatch_bound("create_procedural_texture", locals())

    def create_color_ramp(self, material_name: str, slot: str = 'Base Color', stops: Optional[list] = None) -> Dict[str, Any]:
        """Create a ColorRamp node and insert it in the material node tree."""
        return self._dispatch_bound("create_color_ramp", locals())

    def mix_shaders(self, material_name: str, shader1: str = 'Principled BSDF', shader2: str = 'Principled BSDF', blend_factor: float = 0.5, output_material: Optional[str] = None) -> Dict[str, Any]:
        """Mix two shaders using a Mix Shader node."""
        return self._dispatch_bound("mix_shaders", locals())

    def create_emission_material(self, name: str, color: tuple = (1.0, 1.0, 1.0, 1.0), strength: float = 1.0) -> Dict[str, Any]:
    ...
    def set_normal_map(self, material_name: str, texture_path: str, strength: float = 1.0, color_ramp: Optional[tuple] = None) -> Dict[str, Any]:
        """Create a Normal Map node with a texture and link to BSDF Normal input."""
        return self._dispatch_bound("set_normal_map", locals())

    def set_displacement(self, material_name: str, texture_path: str, method: str = 'Bump', displacement_material: str = 'Material Output') -> Dict[str, Any]:
        """Set up displacement (Bump or Displacement) node."""
        return self._dispatch_bound("set_displacement", locals())

    def create_material_group(self, name: str, node_type: str = 'Group', inputs: Optional[list] = None) -> Dict[str, Any]:
    ...
    def set_anisotropic(self, material_name: str, anisotropy: float = 0.5, anisotropy_rotation: float = 0.0) -> Dict[str, Any]:
    ...
    def set_environment_lighting(self, world_color: tuple = (0.05, 0.05, 0.08, 1.0), world_strength: float = 1.0, use_texture: bool = False, texture_path: Optional[str] = None) -> Dict[str, Any]:
        """Configure the scene's world lighting."""
        return self._dispatch_bound("set_environment_lighting", locals())

    def create_camera(self, name: str = 'Camera', location: tuple = (5.0, -5.0, 3.0), rotation: tuple = (-0.5, 0.0, 0.3), lens: float = 50.0, sensor_width: float = 36.0) -> Dict[str, Any]:
    ...
    def batch_apply_material(self, object_names: List[str], material_name: str, replace_existing: bool = True) -> Dict[str, Any]:
        """Apply the same material to multiple objects in one operation."""
        return self._dispatch_bound("batch_apply_material", locals())

    def batch_set_transform(self, object_names: List[str], location: Optional[tuple] = None, rotation: Optional[tuple] = None, scale: Optional[tuple] = None) -> Dict[str, Any]:
        """Set transform (location, rotation, scale) for multiple objects."""
        return self._dispatch_bound("batch_set_transform", locals())

    def batch_make_duplicates(self, object_names: List[str], count_per_object: int = 2, offset: tuple = (1.0, 0.0, 0.0), randomize: bool = False) -> Dict[str, Any]:
    ...
    def batch_delete(self, object_names: List[str], also_clearance: bool = False, also_materials: bool = False) -> Dict[str, Any]:
        """Delete multiple objects from the scene."""
        return self._dispatch_bound("batch_delete", locals())

    def batch_set_visibility(self, object_names: List[str], visible: bool = True, hide_render: bool = False, hide_select: bool = False) -> Dict[str, Any]:
        """Set visibility state for multiple objects."""
        return self._dispatch_bound("batch_set_visibility", locals())

    def batch_make_parent(self, child_names: List[str], parent_name: str, keep_transform: bool = True) -> Dict[str, Any]:
        """Make multiple objects children of a single parent."""
        return self._dispatch_bound("batch_make_parent", locals())

    def batch_make_empty_group(self, object_names: List[str], group_name: str = 'SelectionGroup', create_collection: bool = False) -> Dict[str, Any]:
        """Create an Empty parent for a group of objects and group them."""
        return self._dispatch_bound("batch_make_empty_group", locals())

    def batch_apply_modifiers(self, object_names: List[str], modifier_names: Optional[List[str]] = None, apply_all: bool = True) -> Dict[str, Any]:
        """Apply specified modifiers (or all) on multiple objects."""
        return self._dispatch_bound("batch_apply_modifiers", locals())

    def batch_mirror(self, object_names: List[str], axis: str = 'X', merge_vertices: bool = True, use_clip: bool = True) -> Dict[str, Any]:
        """Apply Mirror modifier to multiple objects (non-destructive)."""
        return self._dispatch_bound("batch_mirror", locals())

    def batch_instance_on_points(self, template_object_names: List[str], points_object_name: str, random_rotation: bool = False, random_scale: bool = False) -> Dict[str, Any]:
    ...
    def batch_align_bounding_boxes(self, object_names: List[str], alignment: str = 'center', reference: str = 'world') -> Dict[str, Any]:
        """Align bounding box centers of multiple objects."""
        return self._dispatch_bound("batch_align_bounding_boxes", locals())

    def set_render_eevee(self, samples: int = 128, denoise: bool = True, tile_size: int = 32, taa_samples: int = 128) -> Dict[str, Any]:
        """Configure Eevee render engine settings."""
        return self._dispatch_bound("set_render_eevee", locals())

    def set_render_cycles(self, samples: int = 1024, denoise: bool = True, engine: str = 'OPTIX', use_denoising: bool = True) -> Dict[str, Any]:
        """Configure Cycles render engine settings."""
        return self._dispatch_bound("set_render_cycles", locals())

    def set_render_output(self, filepath: str, format: str = 'PNG', color_depth: str = '16', compression: int = 15, transparent: bool = False, ffmpeg: Optional[dict] = None) -> Dict[str, Any]:
        """Configure render output path, format, and quality."""
        return self._dispatch_bound("set_render_output", locals())

    def render_viewport(self, filepath: str, quality: int = 95, resolution_scale: float = 1.0, crop_to_bounds: bool = False) -> Dict[str, Any]:
        """Render the current viewport (what's visible in the 3D view)."""
        return self._dispatch_bound("render_viewport", locals())

    def render_animation_batch(self, filepath: str, frame_start: int = 1, frame_end: int = 250, frame_step: int = 1, format: str = 'FFMPEG', ffmpeg_settings: Optional[dict] = None) -> Dict[str, Any]:
        """Render a full animation sequence in batch mode."""
        return self._dispatch_bound("render_animation_batch", locals())

    def render_multi_view(self, filepath: str, camera_angles: Optional[list] = None, format: str = 'PNG') -> Dict[str, Any]:
        """Render the scene from multiple camera angles."""
        return self._dispatch_bound("render_multi_view", locals())

    def render_360_panorama(self, filepath: str, fov: float = 180.0, resolution: tuple = (4096, 2048), format: str = 'PNG') -> Dict[str, Any]:
    ...
    def render_preview(self, filepath: str, resolution_scale: float = 0.5, samples: int = 64, timeout: int = 30) -> Dict[str, Any]:
    ...
    def import_fbx(self, filepath: str, automatic_orientation: bool = True, import_hardware: bool = True, force_connect_children: bool = False) -> Dict[str, Any]:
        """Import an FBX file into the Blender scene."""
        return self._dispatch_bound("import_fbx", locals())

    def import_obj(self, filepath: str, add_normals: bool = True, split_objects: bool = True, split_groups: bool = True, import_images: bool = True) -> Dict[str, Any]:
    ...
    def import_stl(self, filepath: str, forward_axis: str = '-Z', up_axis: str = 'Y', scale: float = 1.0) -> Dict[str, Any]:
        """Import an STL file (typically 3D print meshes)."""
        return self._dispatch_bound("import_stl", locals())

    def export_fbx(self, filepath: str, object_names: Optional[List[str]] = None, bake_anim: bool = True, use_selection: bool = False, apply_scale_options: str = 'FBX') -> Dict[str, Any]:
        """Export scene (or selection) as FBX."""
        return self._dispatch_bound("export_fbx", locals())

    def export_glb(self, filepath: str, object_names: Optional[List[str]] = None, export_selected: bool = False, export_normals: bool = True, export_materials: bool = True, export_animations: bool = True, compression: bool = True) -> Dict[str, Any]:
        """Export scene as GLB (compressed GLTF, self-contained)."""
        return self._dispatch_bound("export_glb", locals())

    def export_obj(self, filepath: str, object_names: Optional[List[str]] = None, export_selected: bool = False, export_normals: bool = True, export_uv: bool = True, export_materials: bool = False, use_mesh_modifiers: bool = True, smooth_groups: bool = True) -> Dict[str, Any]:
        """Export scene as OBJ (wavefront format)."""
        return self._dispatch_bound("export_obj", locals())

    def export_stl(self, filepath: str, object_names: Optional[List[str]] = None, binary_format: bool = True) -> Dict[str, Any]:
    ...
    def export_animation_fbx(self, filepath: str, object_names: List[str], frame_start: int = 1, frame_end: int = 250, use_subsets: bool = False, subset_prefix: str = '') -> Dict[str, Any]:
        """Export only animation data for selected objects as FBX."""
        return self._dispatch_bound("export_animation_fbx", locals())

    def export_animation_gltf(self, filepath: str, object_names: List[str], frame_start: int = 1, frame_end: int = 250, compression: bool = True, export_all_transforms: bool = True) -> Dict[str, Any]:
        """Export animation as compressed GLB with animation data."""
        return self._dispatch_bound("export_animation_gltf", locals())

    def import_scene_blend(self, filepath: str, append_objects: Optional[List[str]] = None, append_materials: bool = False, link_library: bool = False) -> Dict[str, Any]:
        """Append/link objects from another .blend file."""
        return self._dispatch_bound("import_scene_blend", locals())

    def import_csv_data(self, filepath: str, target_object_name: str, position_column: str = 'x', scale_column: str = 'scale', object_type: str = 'Sphere', count: int = 100) -> Dict[str, Any]:
        """Import CSV data and create objects at specified positions."""
        return self._dispatch_bound("import_csv_data", locals())

    def capture_scene_snapshot(self, filepath: str, include_rendered: bool = True, resolution: tuple = (1920, 1080), format: str = 'PNG', quality: int = 95) -> Dict[str, Any]:
        """Capture a full scene snapshot including rendered image + metadata."""
        return self._dispatch_bound("capture_scene_snapshot", locals())

    def capture_viewport_snapshot(self, filepath: str, crop_to_bounds: bool = False, show_objects: bool = True, show_grid: bool = False, show_axes: bool = False, resolution_scale: float = 1.0) -> Dict[str, Any]:
        """Capture the current viewport as an image (no render)."""
        return self._dispatch_bound("capture_viewport_snapshot", locals())

    def capture_camera_view(self, camera_name: str, filepath: str, render_pass: str = 'FINAL', resolution: tuple = (1920, 1080)) -> Dict[str, Any]:
        """Render a specific camera view at a specific render pass."""
        return self._dispatch_bound("capture_camera_view", locals())

    def capture_all_cameras(self, output_dir: str, resolution: tuple = (1920, 1080), format: str = 'PNG', render_pass: str = 'FINAL') -> Dict[str, Any]:
